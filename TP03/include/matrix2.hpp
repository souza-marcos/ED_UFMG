...
class Matrix2 {
    public:
        ...
        Matrix2 operator*(const Matrix2& other){
            ...
            LEMEMLOG((long int)&other.a11, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&other.a12, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&other.a21, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&other.a22, sizeof(ll), ID_SEG);

            LEMEMLOG((long int)&a11, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&a12, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&a21, sizeof(ll), ID_SEG);
            LEMEMLOG((long int)&a22, sizeof(ll), ID_SEG);

            ESCREVEMEMLOG((long int)&res.a11, sizeof(ll), ID_SEG);
            ESCREVEMEMLOG((long int)&res.a12, sizeof(ll), ID_SEG);
            ESCREVEMEMLOG((long int)&res.a21, sizeof(ll), ID_SEG);
            ESCREVEMEMLOG((long int)&res.a22, sizeof(ll), ID_SEG);
